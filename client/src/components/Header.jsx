    ...
    <div className='flex items-center justify-between max-sm:flex-col reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20 '>
        ...
        <div>
            <h1 className='text-4xl xl:text-4xl 2xl:text-6xl font-bold text-neutral-700 leading-tight' >Remove the <br className='max-m`d:hidden' />
             ...
             <p className='my-6 text-[15px] text-gray-500'>  Erase image backgrounds instantly with smart AI technology. <br className='max-sm:hidden' />
  Create transparent images in just one click — fast, clean, and free.
             </p>
